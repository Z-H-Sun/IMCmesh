...
## Workflow for M<sup>15</sup> structure generation and elucidation
...
[`calc_f.py`](/calc_f.py)
> Monte Carlo estimation of the volume fraction of the region where $F(x,y,z) > T$. *F* = O<sup>70</sup>, M<sup>15</sup>, or T<sup>131</sup> level surface. A scatter 3D plot of the region will be given in real time.
